...
namespace LineGame
{
    public class DrawLineWithGravity : SingletonMonoBehaviour<DrawLineWithGravity>
    {
        //잉크 총량
        ...
        void BeginDraw()
        {
            ...
            currentLine = Instantiate(linePrefab, this.transform).GetComponent<LineWithGravity>();
        ...
        public void ToggleEnable()
        {
            ...
            {
                UI_Ingame_R.Instance.lineWithGravityToggleCheck.gameObject.SetActive(true);
                enableDraw = true;
            }
            else if (activeToggle.isOn == false)
            {
                UI_Ingame_R.Instance.lineWithGravityToggleCheck.gameObject.SetActive(false);
                enableDraw = false;
            }
        }
        ...
        {
            maxInk_line = MissionObjectList.Instance.objectList.BuildIndexToLevelIndex().Ink_LineWithGravity;
            cam = null;
            activeToggle = null;
