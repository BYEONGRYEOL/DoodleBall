...
{
    public class UI_LevelSelecter2_Hard : UI_Menu<UI_LevelSelecter2_Hard>
    {
        #region INSPECTOR
        ...
        public void UpdateInfo()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                currentLevelList.Add(levelSelecter.GetLevel(MissionObjectList.Instance.easyLevelCount + MissionObjectList.Instance.normalLevelCount + i + (page * 10)));
                //별 개수 나오게하고싶은데 ㅠㅠ
        ...
        {
            if (MissionObjectList.Instance.hardLevelCount > (page * 10) + 1)
            {
                playLevelIndex = 1;
                OnBtnPlayPressed();
            }
        ...
        {
            if (MissionObjectList.Instance.hardLevelCount > (page * 10) + 2)
            {
                playLevelIndex = 2;
                OnBtnPlayPressed();
            }
        ...
        {
            if (MissionObjectList.Instance.hardLevelCount > (page * 10) + 3)
            {
                playLevelIndex = 3;
                OnBtnPlayPressed();
            }
        ...
        {
            if (MissionObjectList.Instance.hardLevelCount > (page * 10) + 4)
            {
                playLevelIndex = 4;
                OnBtnPlayPressed();
            }
        ...
        {
            if (MissionObjectList.Instance.hardLevelCount > (page * 10) + 5)
            {
                playLevelIndex = 5;
                OnBtnPlayPressed();
            }
        ...
        {
            if (MissionObjectList.Instance.hardLevelCount > (page * 10) + 6)
            {
                playLevelIndex = 6;
                OnBtnPlayPressed();
            }
        ...
        {
            if (MissionObjectList.Instance.hardLevelCount > (page * 10) + 7)
            {
                playLevelIndex = 7;
                OnBtnPlayPressed();
            }
        ...
        {
            if (MissionObjectList.Instance.hardLevelCount > (page * 10) + 8)
            {
                playLevelIndex = 8;
                OnBtnPlayPressed();
            }
        ...
        {
            if (MissionObjectList.Instance.hardLevelCount > (page * 10) + 9)
            {
                playLevelIndex = 9;
                OnBtnPlayPressed();
            }
        ...
        {
            if (MissionObjectList.Instance.hardLevelCount > (page * 10) + 10)
            {
                playLevelIndex = 10;
                OnBtnPlayPressed();
            }
